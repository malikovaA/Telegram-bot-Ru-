...
class Test_name(Base):
    ...
    questions = relationship('Test_question', backref='test_name')
...
session.add_all([c6,c7,c8,c9,t1,t2,t3,t4,t1,tt1,tt2,tt3,tt4])
session.commit()

# for i in session.query(Class.title).all():
#     print(i[0])
